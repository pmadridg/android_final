...
public class ApiClient {
    ...
    public interface ServicesApiInterface {
        ...
        @GET("/{applicationid}/{restapikey}/data/Buffet")
        Call<BuffetResponse> showBuffet(@Path("applicationid") String appID,
                                      @Path("restapikey") String restApiKEY, @HeaderMap Map<String, String> headers);

        @POST("/{applicationid}/{restapikey}/data/Cart")
        Call<Object> addCart(@Path("applicationid") String appID,
                               @Path("restapikey") String restApiKEY, @HeaderMap Map<String, String> headers,
                               @Body CartRaw cartRaw);
